...
export const CONFIG = {
	...
	authorization: {
		username: process.env.AUTHORIZATION_USERNAME || "itera", // 'areti',
		passsword: process.env.AUTHORIZATION_PASSWORD || "areti", //'p!s4n9-g0d0k-s3g0-t!wul'
	},
	base_url: process.env.BASE_URL || `http://localhost:${process.env.APP_PORT}`, //lucky-bedclothes-dove.cyclic.app
};

...
export const route = (app: Express): any => {
  ...
  app.use('/api/v1/statistic', middleware.useAuthorization, statisticRouter)
  statisticRouter.get(
    '/',
  ...
  app.use('/api/v1/users', middleware.useAuthorization, userRouter)
  userRouter.get(
    '/list',
  ...
  app.use('/api/v1/admin', middleware.useAuthorization, adminRouter)
  adminRouter.patch(
    '/',
  ...
  app.use('/api/v1/vehicles', middleware.useAuthorization, vehicleRouter)
  vehicleRouter.get(
    '/',
  ...
  app.use('/api/v1/traffic', middleware.useAuthorization, trafficRouter)
  trafficRouter.post(
    '/verify',
